...
@section('content')
    ...
    <h1>Conditions générales d'utilisation du site <strong>www.url.com</strong></h1>
    <br>
    <div class="container-fluid">
        <h2>ARTICLE 1 : Objet</h2>
            <p>Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site <strong>url.com</strong> et leur utilisation par « l'Utilisateur ».</p>
            ...
            <p>Éventuellement :</p>
                ...
                <li><strong>url.com</strong> se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</li>

        <br>

        <h2>ARTICLE 2 : Mentions légales</h2>
            <p>L'édition du site <strong>url.com</strong> est assurée par la Société <strong>Sociedad SARL</strong> au capital de XXXXX €
                dont le siège social est situé au <strong>66 rue Abbé de l'Epée, 33000 Bordeaux</strong>.
            <br><strong>Le Directeur</strong> de la publication est <strong>Monsieur Directeur Toto</strong>.</p>
            <p>Éventuellement :</p>
                <li><strong>Sociedad</strong> est une société du groupe <strong>Sociedad SARL</strong> au capital de <strong>XXXXX €</strong>
                    dont le siège social est situé au <strong>66 rue Abbé de l'Epée, 33000 Bordeaux</strong>.</li>
            <br>
            <p>L'hébergeur du site <strong>url.com</strong> est la Société <strong>OVH</strong> au capital de <strong>XXXXX €</strong>
                dont le siège social est situé au <strong>2 rue Kellerman, 59100 Roubaix</strong>.</p>
        ...
        <h2>ARTICLE 4 : accès aux services</h2>
            <p>Le site permet à l'Utilisateur un accès gratuit aux services suivants :</p>
                <li><strong>Jouer au jeu</strong> ;</li>
                <li><strong>Utiliser l'outil de création</strong> ;</li>
                <li><strong>publication de commentaires / d’œuvres personnelles]</strong> ;</li>
            ...
            <li>Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de <strong>url.com</strong>.</li>
            ...
            <li>L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse [contact@nomdusite.com].</li>
        ...
        <h2>ARTICLE 6 : Données personnelles</h2>
            ...
            <p>Le site assure à l'Utilisateur une collecte et un traitement d'informations personnelles dans le respect de la vie privée conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés.
                Le site est déclaré à la CNIL sous le numéro <strong>XXXXXXX</strong>.</p>
            <p>En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. L'Utilisateur exerce ce droit via :</p>
                ...
                <li>par mail à <strong>toto@email.com</strong> ;</li>
                <li>par voie postale au <strong>66 rue Abbé de l'Epée, 33000 Bordeaux</strong>.</li>
        ...
        <h2>ARTICLE 8 : Liens hypertextes</h2>
            <p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de <strong>url.com</strong> qui n'a pas le contrôle de ces liens.</p>
        ...
        <h2>ARTICLE 11 : Droit applicable et juridiction compétente</h2>
            ...
            <p>La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né entre les parties, seuls les tribunaux <strong>du ressort de la Cour d'appel la ville de Bordeaux</strong> sont compétents.</p>

        <br>

        <h2>ARTICLE 12 : Publication par l’Utilisateur</h2>
            <p>Le site permet aux membres de publier <strong>des œuvres personnelles</strong>.</p>
            <p>Dans ses publications, le membre s’engage à respecter les règles de la Netiquette et les règles de droit en vigueur.</p>
            <p>Le site exerce une modération <strong>a posteriori</strong> sur les publications et se réserve le droit de refuser leur mise en ligne, sans avoir à s’en justifier auprès du membre.</p>
